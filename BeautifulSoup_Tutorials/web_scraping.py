...
tag = doc.title
print(tag.string) # Note: if tag or tag.string was changed in value, this would be updated in the doc too!
...
result = requests.get(url) # result obtained by the requests module making a get request to url
